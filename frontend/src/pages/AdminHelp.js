...
const SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: "Automatic expiry reminder emails", a: "If you set an expiry date on a gallery's share link, StudioApp automatically emails your client 7 days before it expires — a warm, friendly reminder to download all their high-resolution photos (and videos) before the gallery closes. It sends once per gallery and is logged in your Activity. Two things must be in place: (1) add your client's email to the gallery (open the gallery and set the client email), and (2) set up your sending email under Settings → Email so reminders can go out from your own address." },
  ...
  },
  {
    ...
    items: [
      ...
      { q: "Automatic gallery-expiry reminders", a: "StudioApp sends your client an automatic reminder 7 days before a gallery's share link is due to expire, nudging them to download everything in good time. It uses your sending email (set up here) and the client email saved on the gallery. See 'Sharing → Automatic expiry reminder emails' for the full details." },
